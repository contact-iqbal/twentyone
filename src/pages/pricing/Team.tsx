...
import { Users, Check, Shield, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Team <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Pricing</span>
            </motion.h1>
            ...
            >
              Empower your team with collaborative learning. Perfect for small to medium-sized teams looking to upskill together.
            </motion.p>
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-black text-gray-900 mb-4">Team Benefits</h2>
            <p className="text-gray-600 max-w-2xl mx-auto font-medium">
              Everything your team needs to learn and grow together
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Users, title: 'Team Dashboard', description: 'Track team progress' },
              { icon: Shield, title: 'Admin Controls', description: 'Manage team access' },
              { icon: Check, title: 'Bulk Enrollment', description: 'Enroll multiple users' },
              { icon: ArrowRight, title: 'Priority Support', description: 'Dedicated team support' }
            ].map((feature, index) => (
              <motion.div
                key={index}
                initial={{ y: 50, opacity: 0 }}
